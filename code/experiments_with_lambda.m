...
if strcmp(variant,'Additive')
	...
	attenuation, rrmse_list = additiveART(radon_transform, imaging_matrix, n_iter, num_views, start_ang, del_ang, stop_ang, lambda);

elseif strcmp(variant,'Multiplicative')
	
	attenuation, rrmse_list = multiplicativeART(radon_transform, imaging_matrix, n_iter, num_views, start_ang, del_ang, stop_ang, lambda);
	
elseif strcmp(variant,'SIRT')
	
	attenuation, rrmse_list = simultaneousIRT(radon_transform, imaging_matrix, n_iter, num_views, start_ang, del_ang, stop_ang, lambda);
